...
@WebServlet("/IndexLeadRegister")
public class IndexLeadRegister extends HttpServlet {
	    ...
	    protected void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
	        ...
	        try {
	            ...
	            if (formItems != null && formItems.size() > 0) {
	                ...
	                String description=fieldvalue[2];
	    			String name=fieldvalue[3];
	    			email=fieldvalue[4];
	    			long mobileNumber=Long.parseLong((fieldvalue[5]));
	    			String address=fieldvalue[9];
	    			Timestamp timestamp=TimestampGenerator.getTimestamp();
	    			int budget_range_id=Integer.parseInt(fieldvalue[6]);
	    			...
	    			if(postal_code>0){
		    			...
		    			/*loc.setLocationName(fieldvalue[8]);*/
