...
@WebServlet("/DocumentUpdater")
public class DocumentUpdater extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (formItems != null && formItems.size() > 0) {
                ...
                document.setDocument_id(Integer.parseInt(fieldvalue[3]));
                ...
                res=docDao.updateDocument(document);
			...
			if(res>0){
				...
				response.sendRedirect("DocumentController?action=showAllDocuments&result=documentUpdated");
				...
				response.sendRedirect("DocumentController?action=showAllDocuments&result=documentUpdateFailed");
