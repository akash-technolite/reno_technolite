			...
			<div class="">
				...
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#validationforms">Create Lead</a>
					</div>
				</div>
				</nav>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								<div style="margin-top: 50px; margin-bottom: 50px" class="card">
									...
									<!--  id="LeadRegisterForm" -->
									<form id="conCreateLeadForm" action="ContractorCreateLead"
												...
												<div class="col-md-6">
														<fieldset style="margin-bottom: 15px !important;">
															<div class="form-group">
																<div class="col-md-4 ">
																	<label class="control-label"
																		style="margin-top: 20px !important;">Describe
	                                          ...
	                                          <div class="form-group">
												...
												<div class="col-md-12">
																...
																<div class="col-md-8">
																	<div class="form-group">
																		...
																		<label class="btn btn-default"> Choose File <input
																			type="file" id="files" name="image_file_arr[]"
																			multiple hidden>
																		</label>
	                                             ...
	                                             /> -->
																...
																<input id="contractorId" type="hidden"
																	name="contractorId" value="${sessionScope.userId}">
												...
												<div class="col-md-12">
													<center>
														...
														<div class=" text-danger">
															<star>*</star>
															This leads will get added into applied/buyied lead
															section
														</div>
														<input type="submit" class="btn btn-info btn-fill"
															style="background-color: #de7e31; border-color: #de7e31; margin-top: 10px;"
															value="Submit">
													</center>
												</div>
