			...
			<div class="">
				...
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#validationforms">Work Orders</a>
					</div>
					<span class="navbar-brand pull-right"> <c:if
							test="${sessionScope.user!='installer'}">
					...
					<!-- 	<div class="collapse navbar-collapse">
	                    ...
	                    <ul class="nav navbar-nav navbar-right">
	                        <li>
	                            <a href="WorkOrderController" class=" btn-magnify">
											...
											<tbody>
												<c:forEach items="${ordersList}" var="order">
													<tr>
														...
														<td><a
															href="WorkOrderController?action=workOrderCheckOut&lead_id=${lead.leadID}&work_order_id=${order.work_order_id}">
																<button type="button" class="btn btn-simple btn-info ">Print</button>
														</a> <a target="_blank" href="${order.web_path}"
															...
															<form action="WorkOrderController" method="post">
																<input type="hidden" name="action"
																	value="workOrderCheckOut"> <input
																	type="hidden" name="lead_id" value="${lead.leadID}">
																<input type="hidden" name="work_order_id"
																	value="${order.work_order_id}">
																<button class="btn btn-simple btn-info" type="submit">Read</button>
															</form>

															<form action="WorkOrderController" method="post"
																onsubmit="return confirm('Do you really want to delete this work order? This action cannot be undone');">
																<input type="hidden" name="action" value="deleteOrder">
																<input type="hidden" name="lead_id"
																	value="${lead.leadID}"> <input type="hidden"
																	name="work_order_id" value="${order.work_order_id}">
																<button class="btn btn-simple btn-danger" type="submit">Delete</button>
															</form></td>
