																	...
																	<div class="form-group">
																		<select class="selectpicker" id="promoCode"
																			...
																			<c:forEach items="${promotions}" var="promo">
																				<option value="${promo.type}">${promo.discount_amount}</option>
																			</c:forEach>
																		</select>
																	</div>
																</div>
       ...
       */
       ...
       function calculate(){
    	   ...
    	   var subTotal=parseFloat($("#subTotal").val());
     	    var promoType=$("#promoCode option:selected").val();
    	    var promoAmount=parseFloat($("#promoCode option:selected").text());
           ...
           var grossTotal=parseFloat($("#grossTotal").val());
       	 ...
       	 $("#promoDiscount").val($("#promoCode option:selected").text()+$("#promoCode").val());
          }
          else{
