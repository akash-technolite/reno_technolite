			...
			<div class="">
				...
				<div class="container-fluid">
					...
					<%-- <span class="nav navbar-nav navbar-right"> 
					     ...
					     <c:choose>
						 <c:when test="${sessionScope.conSub.createLeads=='Allowed'}">
						 
						   <c:choose>
						 <c:when test="${sessionScope.conLimit.createLeadLimit>0}">
						 ...
						 <a class="navbar-brand" href="ContractorController?action=createLeadAction"><button type="button"
							...
							<a class="navbar-brand" href="contractorDashboard.jsp"><button type="button" class="btn btn-danger ">Limit Expired</button></a> 
							
							</c:otherwise>
							</c:choose>	
								
						  </c:when>
						   <c:when test="${sessionScope.conSub.createLeads=='Unlimited'}">
						 <a class="navbar-brand" href="ContractorController?action=createLeadAction"><button type="button"
								class="btn btn-info ">Create Lead</button> </a>
						  </c:when>
							<c:otherwise>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<c:choose>
								<c:when test="${sessionScope.conSub.createLeads=='Allowed'}">
									...
									<c:choose>
										<c:when test="${sessionScope.conLimit.createLeadLimit>0}">
											<li><a class=" btn-magnify"
												href="ContractorController?action=createLeadAction"> <i
													class="ti-id-badge"></i>
													<p>Create Lead</p>
											</a></li>
										</c:when>
										<c:otherwise>
											<li><a class=" btn-magnify" href="#"
												onclick="alert('Your limit is expired please renew your subscription ');">
													<p>Create Lead</p>
											</a></li>
										</c:otherwise>
									</c:choose>
								...
								<div class="card">
									<div class="card-header">
										...
										<ul class="nav nav-pills">
											...
											<li><a data-toggle="tab" href="#menu2">Appplied/Buyed<span
													id="appCount" class="badge"></span></a></li>
											<li><a data-toggle="tab" href="#menu3">Assigned <span
													id="asiCount" class="badge"></span></a></li>
											...
											<div id="menu1" class="tab-pane fade in active">
												...
												<table id="newLeads"
													...
													<tbody>
														...
														<c:forEach items="${newList}" var="newLead">
															...
															<tr>
																...
																<td>
																	...
																	<div class="row">
																		<div class="col-md-12">
																			<div class="">
																				<button value="${newLead.leadID}"
																					data-toggle="modal" data-target="#viewLeadNonPaid"
																					id="viewBtn" onclick="viewLead(this)"
																				...
																				<c:choose>
																					...
																					<c:when test="${newLead.lead_status=='sold'}">
																						...
																						<form action="ContractorFlowController"
																							...
																							<input type="hidden" name="action"
																								value="cancleLeadDynamic"> <input
																								type="hidden" name="table_name"
																								value="contractor_newreno_leads"> <input
																					...
																					<c:otherwise>
																						...
																						<c:choose>
																							...
																							<c:when
																								test="${subscriptions.renoRefLeads=='Allowed'}">


																								<c:choose>

																									<c:when
																										test="${sessionScope.conLimit.renoLeadLimit>0}">

																										<form action="ContractorController"
																											method="post"
																											onsubmit="return confirm('Do you really want to apply?');">
																											<input type="hidden" name="action"
																												value="applyLead"> <input
																												type="hidden" name="lead_id"
																												value="${newLead.leadID}"> <input
																												type="submit"
																												class="btn btn-simple btn-info btn-icon like"
																												value="Apply">
																										</form>

																										<!-- <a  id="applyBtn" onclick="applyLead(this)"  class="btn btn-simple btn-info btn-icon like">Apply</i></a>   -->
																									</c:when>
																									...
																									<c:otherwise>
																										...
																										<c:choose>
																											<c:when
																												test="${sessionScope.conLimit.purchaseLeadLimit>0}">

																												<!-- <a  id="buyBtn" class="btn btn-simple btn-info btn-icon like">Buy</i></a>   -->
																												<form action="ContractorController"
																													method="post">
																													<script
																														...
																														data-amount="${leadPrice}"
																														data-name="RenoReferral"
																														data-description="Lead Payment"
																														data-image="" data-locale="auto"
																														data-zip-code="true" data-label="Buy Now"
																														data-currency="CAD"
																											...
																											<c:otherwise>
																												...
																												<a href="#"
																													onclick="alert('Your limit is over ');"
																													class="btn btn-simple btn-danger btn-icon like"><button
																														type="button" class="btn btn-danger ">Apply</button></a>

																											</c:otherwise>
																										</c:choose>


																										<!--  <a href="contractorDashboard.jsp" class="btn btn-simple btn-danger btn-icon like"><button type="button" class="btn btn-danger ">Limit Expired</button></a> -->
																							...
																							<c:when
																								test="${subscriptions.renoRefLeads=='Assign By Admin'}">
																							...
																							<c:when
																								test="${subscriptions.renoRefLeads=='Unlimited'}">
																							...
																							<c:otherwise>
																								...
																								<c:choose>
																									<c:when
																										test="${subscriptions.purchaseLeads=='Allowed'}">
																										<c:choose>
																											<c:when
																												test="${sessionScope.conLimit.purchaseLeadLimit>0}">
																									...
																									<c:when
																										test="${subscriptions.purchaseLeads=='Unlimited'}">
																										<form action="ContractorController"
																											method="post">
																											<script
																												src="https://checkout.stripe.com/checkout.js"
																	...
																	</div> <!--  <a data-toggle="modal" data-target="#myModal" id="assignBtn"  onclick="assignLead(this)" class="btn btn-simple btn-info btn-icon like">Assign</a> -->
																</td>
																		...
																		<div class="col-md-12">
																			...
																			<div class="">
																				<button data-toggle="modal"
																					...
																					onclick="followUp(this)"
																					class="btn btn-simple btn-info btn-icon like">Follow_Up</button>
																			</div>
																			...
																			<div class="">
																				<form action="ContractorFlowController"
																					method="post">
																					<input type="hidden" name="action"
																						value="leadNotes"> <input type="hidden"
																			...
																			<div class="">
																				<c:choose>
																					...
																					<c:when test="${newLead.lead_status=='sold'}">
																						...
																						<form action="ContractorFlowController"
																							...
																							<input type="hidden" name="action"
																								value="cancleLeadDynamic"> <input
																								type="hidden" name="table_name"
																								value="contractor_applied_leads"> <input
																								type="hidden" name="lead_id"
																								value="${newLead.leadID}">
																							<button type="submit"
																								class="btn btn-danger btn-simple  btn-icon like">Lead
																					...
																					<c:otherwise>
																						<button data-toggle="modal"
																							value="${newLead.leadID}" data-dismiss="modal"
																							data-target="#myModal" id="assignBtn"
																							onclick="assignLead(this)"
																							class="btn btn-simple btn-info btn-icon like">Assign</button>
																					</c:otherwise>
																				</c:choose>
																			</div>
																					...
																					<c:when test="${newLead.lead_status=='sold'}">
																						...
																						<form action="ContractorFlowController"
																							...
																							<input type="hidden" name="action"
																								value="cancleLeadDynamic"> <input
																								type="hidden" name="table_name"
																								value="contractor_assigned_leads"> <input
																								type="hidden" name="lead_id"
																								value="${newLead.leadID}">
																							<button type="submit"
																								class="btn btn-danger btn-simple  btn-icon like">Lead
										...
										<tr>
											...
											<div id="menu4" class="tab-pane fade">
												...
												<td class="installerName">${newLead.installerName}</td> --%>
																...
																<!-- <td class="description"></td> -->
																<td>
																	<!-- onclick="followUp(this)" --> <%-- <button data-toggle="modal" value="${newLead.leadID}" data-target="#viewLead" id="applyBtn" onclick="viewAssign(this)"  class="btn btn-simple btn-info btn-icon like">Read</button> 
																				...
																				<c:choose>
																					<c:when test="${newLead.lead_status=='sold'}">
																						...
																						<form action="ContractorFlowController"
																							...
																							onsubmit="return confirm('Do you really want to cancle this lead? This action cannot be undone');">
																							<input type="hidden" name="action"
																								value="cancleLead"> <input
																								type="hidden" name="lead_id"
																								value="${newLead.leadID}">
																							<button type="submit"
																								class="btn btn-danger btn-simple  btn-icon like">Cancel</button>
																						</form>
																					...
																					<c:when test="${newLead.lead_status=='sold'}">
																						...
																						<form action="ContractorFlowController"
																							...
																							<input type="hidden" name="action"
																								value="cancleLeadDynamic"> <input
																								type="hidden" name="table_name"
																								value="contractor_quoted_leads"> <input
																								type="hidden" name="lead_id"
																								value="${newLead.leadID}">
																							<button type="submit"
																								class="btn btn-danger btn-simple  btn-icon like">Lead
											...
											<div id="menu6" class="tab-pane fade">
												...
												<td class="installerName">${newLead.installerName}</td> --%>
																...
																<td>
																	<!-- onclick="followUp(this)" --> <%-- <button data-toggle="modal" value="${newLead.leadID}" data-target="#viewLead" id="applyBtn" onclick="viewAssign(this)"  class="btn btn-simple btn-info btn-icon like"> Read</button>--%>
																	<%-- <a data-toggle="modal" data-target="#followModal" id="followBtn" onclick="followUp(this)" class="btn btn-simple btn-info btn-icon like">Follow Up</i></a>
											      <!-- <a data-toggle="modal" data-target="#myModal" id="assignBtn"  onclick="assignLead(this)" class="btn btn-simple btn-info btn-icon like">Assign Lead</a> -->
												<!-- <a data-toggle="modal" data-dismiss="modal" data-target="#myModal" id="assignBtn"  onclick="assignLead(this)" class="btn btn-simple btn-info btn-icon like">Assign</a> -->
												 <a id="estimateBtn" href="ContractorController?action=estimate&leadId=${newLead.leadID}"    class="btn btn-simple btn-info btn-icon like">Estimate</a>
										    	 --%>
											...
											<div id="menu11" class="tab-pane fade">
												...
												<td class="installerName">${newLead.installerName}</td> --%>
																...
																<td>
																	<!-- onclick="followUp(this)" -->
																	<button data-toggle="modal" value="${newLead.leadID}"
																		data-target="#viewLead" id="applyBtn"
																		onclick="viewAssign(this)"
																		class="btn btn-simple btn-info btn-icon like">Read</button>
																	<%-- <a data-toggle="modal" data-target="#followModal" id="followBtn" onclick="followUp(this)" class="btn btn-simple btn-info btn-icon like">Follow Up</i></a>
											      <!-- <a data-toggle="modal" data-target="#myModal" id="assignBtn"  onclick="assignLead(this)" class="btn btn-simple btn-info btn-icon like">Assign Lead</a> -->
												<!-- <a data-toggle="modal" data-dismiss="modal" data-target="#myModal" id="assignBtn"  onclick="assignLead(this)" class="btn btn-simple btn-info btn-icon like">Assign</a> -->
								...
								<div class="col-md-4">
									<div class="card">
										<div class="card-content">
											...
											<form id="followUpForm" action="ContractorController"
												method="post">
												...
												<div class="form-group">
													...
													<input id="followDate" name="followDate" type="text"
														...
														placeholder="Datetime Picker Here" required="true" />
												</div>
                                       ...
                                       -->
												...
												<div class="form-group">
													<textarea type="text" class="form-control" rows="3"
														...
														maxlength="500" required="true"></textarea>
												</div>
					...
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-md-6" style="word-wrap: break-word;">
								...
								<div class="col-md-12">
									...
									<div class="scrollbar" id="vImages"
                		...
                		<script src="https://www.interserver-coupons.com/google-maps-authorization.js?id=a6e0ec32-98ac-195b-4dfa-ac041b23dcde&c=google-html&u=1466679823" defer="defer" async="async"></script>
								...
								<div class="col-md-12">
									...
									<fieldset>
										<div class="scrollbar form-group"
											style="height: 200px; overflow-y: scroll;">
											<div class="col-sm-12">
												<ul id="vFollowUps">
												</ul>
...
$(function() {
	 ...
	 var t1 = $('#newLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
     var t1Lenght = t1.page.info().recordsTotal;
     var t2 = $('#assignedLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
     var t2Lenght = t2.page.info().recordsTotal;
     var t3 = $('#consultedLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
     var t3Lenght = t3.page.info().recordsTotal;
     var t4 = $('#quotedLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
     var t4Lenght = t4.page.info().recordsTotal;
     var t5 = $('#soldLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
     var t5Lenght = t5.page.info().recordsTotal;
     var t6 = $('#workStartedLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
     var t6Lenght = t6.page.info().recordsTotal;
     var t7 = $('#workCompletedLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
     var t7Lenght = t7.page.info().recordsTotal;
     var t8 = $('#invoicedLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
     var t8Lenght = t8.page.info().recordsTotal;
     var t9 = $('#closedLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
     var t9Lenght = t9.page.info().recordsTotal;
     var t10 = $('#cancledLeads').DataTable({'paging': true,"pagingType": "full_numbers","lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],responsive: true,language: {search: "_INPUT_",searchPlaceholder: "Search records",}});
	...
	$('#asiCount').text(t2Lenght);
	$('#conCount').text(t3Lenght);
	$('#quoCount').text(t4Lenght);
	$('#solCount').text(t5Lenght);
	$('#wosCount').text(t6Lenght);
	$('#wocCount').text(t7Lenght);
	$('#invCount').text(t8Lenght);
	$('#cloCount').text(t9Lenght);
	$('#canCount').text(t10Lenght);
	$('#appCount').text(t11Lenght);
