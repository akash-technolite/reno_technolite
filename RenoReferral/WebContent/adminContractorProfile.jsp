					...
					<div class="collapse navbar-collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							<li>
							   ...
							   <input type="hidden" name="contractorId" value="${contractorList[0].contractorId}">
							  <button type="submit" class="btn btn-simple "><i class="ti-pencil-alt" title="Edit"></i> Edit Profile <span class="badge"></span></button>
								...
								<div class="card card-user">
									...
									<div class="card-content">
										<div class="author">
											...
											<!--  <i class="ti-pencil-alt" data-toggle="modal"data-target="#uploadModal" title="Edit"></i> -->
					...
					<div class="container-fluid">
						...
						<div class="col-md-12">
							<div class="row">
								...
								<div class="form-group">
									<label class="control-label">To<star>*</star></label> <input
										type="text" id="email_id" class="form-control" name="email_id"
										value="${contractorList[0].contractorEmail}"
										readonly="readonly">
								</div>

								<div class="form-group">
									<label class="control-label">Subject<star>*</star></label> <input
										type="text" id="email_subject" class="form-control"
										name="email_subject" maxlength="100" required>
								</div>

								<div class="form-group">
									<label class="control-label">Message<star>*</star></label>
									<textarea type="text" id="email_message" class="form-control"
										maxlength="1000" name="email_message" required></textarea>
								</div>
								...
								<div class="modal-footer">
									<button id="sendMailBtn" type="button"
										class="btn btn-success btn-fill" data-dismiss="modal"
										style="background-color: #de7e31; color: white; border-color: #de7e31;">Send</button>
									<div class="clearfix"></div>
								</div>
