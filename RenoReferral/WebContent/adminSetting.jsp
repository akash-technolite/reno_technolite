										...
										<div class="panel-group" id="accordion">
												...
												<a data-toggle="collapse" href="#collapseOne">
													<div class="panel-heading">
														<h4 class="panel-title">
															Manage Services <i class="ti-angle-down"></i>
														</h4>
													</div>
												</a>
												<div id="collapseOne" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<button class="btn btn-info pull-right"
															data-toggle="modal" data-target="#serviceModal">Add
															Service</button>
											...
											<div class="panel panel-border panel-default">
												<a data-toggle="collapse" href="#collapseTwo">
													<div class="panel-heading">
														<h4 class="panel-title">
															Manage Budget Ranges <i class="ti-angle-down"></i>
														</h4>
													</div>
												</a>
												<div id="collapseTwo" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<button class="btn btn-info pull-right" data-toggle="modal" data-target="#budgetModal">Add
															New Range</button>
												     ...
												     --%>
																				<form action="Setting" method="post"
																					...
																					<input type="hidden" name="action"
																						value="deleteRange"> <input type="hidden"
																						name="ranges_id"
																						value="${budget.budget_ranges_id}">
																					<button
																						class="btn btn-simple btn-danger btn-icon remove"
																						type="submit">
																						<i class="ti-close" title="Close"></i>
											...
											<div class="panel panel-border panel-default">
												<a data-toggle="collapse" href="#collapseThree">
													<div class="panel-heading">
														<h4 class="panel-title">
															Set Lead Price <i class="ti-angle-down"></i>
														</h4>
													</div>
												</a>
												<div id="collapseThree" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<form id="defaultPriceForm" action="Setting" method="post"
															onsubmit="return validateForm()">

															<div class="col-md-12" style="margin-bottom: 10px;">
																<div class="form-group">
																	<div class="col-md-2">
																		<label for="service_name" style="margin-top: 8px;">Price:</label>
																	</div>
																	<div class="col-md-4">
																		<input type="text" number="true" name="price"
																			class="form-control" id="price" maxlength="10"
																			number="true" value="${leadPrice/100}">
																	</div>
																</div>
															</div>
															<input type="hidden" name="action" value="newleadPrice">
															<center>
											...
											<div class="panel panel-border panel-default">
												<a data-toggle="collapse" href="#collapseFour">
													<div class="panel-heading">
														<h4 class="panel-title">
															Set Tax Rates <i class="ti-angle-down"></i>
														</h4>
													</div>
												</a>
												<div id="collapseFour" class="panel-collapse collapse">
													...
													<div class="col-md-10 col-md-offset-1">
													<div class="fresh-datable">
															<table id="taxTable" class="table table-responsive table-striped table-no-bordered table-hover"
																cellspacing="0" width="100%" style="width: 100%">
															<thead>
																<tr>
																    <th>Id</th>
															...
															<tbody>
																...
																<c:forEach items="${taxation}" var="tax"> 
																	...
																	<tr>
																		...
																		<td >${tax.pst}</td>
																		<td >${tax.qst}</td>
																		<td ><button id="editbtn" value="${tax.tax_id}"
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="exampleModalLabel">Edit Taxation</h4>
			</div>
			<div class="modal-body">
				...
				<div class="container-fluid">
					...
					<div class="col-md-12">
						<div class="row">
							<form id="editTaxation" action="Setting" method="post" >


								<div class="">
									<div class="form-group">
										<label class="control-label">Province<star>*</star>
										</label> <input class="form-control" type="text" name="tProvince"
											id="tProvince" autocomplete="off"
									...
									<div class="form-group">
										<label class="control-label">GST(%)<star>*</star>
										</label>
								...
								<div class="form-group">
										<label class="control-label">HST(%)<star>*</star>
										</label>
										 <input class="form-control"
					                                                   type="text"
					                                                   name="tHst"
									...
									<div class="form-group">
										<label class="control-label">PST(%)<star>*</star>
										</label>
										 <input class="form-control"
					                                                   type="text"
					                                                   name="tPst"
									...
									<div class="form-group">
										<label class="control-label">QST(%)<star>*</star>
										</label>
										 <input class="form-control"
					                                                   type="text"
					                                                   name="tQst"
								...
								<input type="hidden" id="tTax_id" name="tTax_id">
								<input type="hidden"  name="action" value="updateTaxation">
								...
								<div class="">
									<div class="modal-footer">
										<button type="submit" class="btn btn-success btn-fill"
											style="background-color: #de7e31; border-color: #de7e31; background-color: #de7e31; color: white; border-color: #de7e31;">Update</button>
...
<script type="text/javascript">
	$().ready(function() {
		...
		$('#defaultPriceForm').validate();
	    $('#editTaxation').validate();	
	});
</script>
          ...
          <span aria-hidden="true">&times;</span> -->
			...
			<div class="modal-body">
				...
				<div class="container-fluid">
					...
					<div class="col-md-12">
						<div class="row">
							<form id="add_service_form" class="form-inline" action="Setting"
								method="post">

								<div class="col-md-12" style="margin-bottom: 10px;">
									<div class="form-group">
										<div class="col-md-5">
											<label for="service_name" style="margin-top: 8px;">Service
												Name :</label>
										</div>
										<div class="col-md-7">
											<input type="text" name="service_name" class="form-control"
												id="service_name" maxlength="20">
										</div>
									</div>
								</div>
...
<script type="text/javascript">
	...
	$(".editbtn").click(function(){
     	 ...
     	 var tax_id=parseInt($(this).val());
     	  
     	
     	  
                 $.post("AjaxForTaxation",
     		    {
                	 tax_id:tax_id,
