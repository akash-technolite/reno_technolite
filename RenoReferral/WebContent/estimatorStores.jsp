										...
										<table id="datatables"
											...
											<tbody>
												<c:forEach items="${storeslist}" var="store">
													...
													<button id="itemsbtn" value="${store.stores_id}" class="btn btn-simple btn-warning btn-icon editbtn" data-toggle="modal"data-target="#editModal"><i class="ti-pencil-alt" title="Edit"></i></button> 
													<form action="StoreController" method="post"
												    onsubmit="return confirm('Please confirm your action');"
												    >
												    <input type="hidden" name="action" value="delete"> 
												    <input type="hidden" name="store_id" value="${store.stores_id}"> 
