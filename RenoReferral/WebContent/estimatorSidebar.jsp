	...
	<div class="sidebar" data-background-color="brown"
		...
		<div class="sidebar-wrapper">
			...
			<ul class="nav">
				...
				<li><a href="EstimatorController?action=showLeads"> <i
						class="ti-id-badge"></i>
						<p>LEADS</p>
				</a></li>
				...
				<li><a href="EstimatorController?action=estimatorComplaints">
						<i class="ti-email"></i>
						<p>COMPLAINTS</p>
				</a></li>


				<li><a href="EstimatorController?action=showAllDocuments">
						<i class="ti-clipboard"></i>
						<p>DOCUMENTS</p>
				</a></li>


				<li><a href="EstimatorController?action=showAllStores"> <i
						class="ti-home"></i>
						<p>STORES</p>
				</a></li>
