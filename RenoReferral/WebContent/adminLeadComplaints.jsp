							...
							<div class="card">
								...
								<div class="card-content">
									<div class="row">
										...
										<div class="container-fluid">
											...
											<ul class="nav  nav-pills nav-justified">
												<li class="nav-item active"><a data-toggle="tab"
													href="#menu1">New</a></li>
												<li><a data-toggle="tab" href="#menu2">Assigned</a></li>
												<li><a data-toggle="tab" href="#menu3">Working</a></li>
										...
										<div class="tab-content" style="padding: 20px !important;">
													...
													<tbody>
														...
														<c:forEach items="${newComplaints}" var="com">
															...
															<tr>
																...
																<td>${com.leadId}</td>
																<td>${com.timestamp}</td>
																<td>${com.complaintText}</td>
																<td><a data-toggle="modal" data-target="#myModal"
																	id="asssignBtn" onclick="assign(${com.complaintId})"
																	class="btn btn-simple btn-info btn-icon like">Assign</a>
											...
											<div id="menu2" class="tab-pane fade in ">
												...
												<form  action="ComplaintController" method="post"
										    	 onsubmit="return confirm('This action cannot be undone');">
												    ...
												    <input type="text" name="lead_id" value="${lead.leadID}" >
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="container">
							<div class="row">
								<form id="assignForm" action="CreateComplaint" method="post">
