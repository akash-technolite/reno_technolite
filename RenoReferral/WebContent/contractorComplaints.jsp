				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
                        	...
                        	<strong style="margin-left: 18px;">Complaints</strong></h3> -->
													...
													<div class="row">
														...
														<div class="container-fluid">
															...
															<ul class="nav  nav-pills nav-justified">
																...
																<li><a data-toggle="tab" href="#menu2">Assigned
																		<span class="badge" id="assCount"></span>
																</a></li>
																<li><a data-toggle="tab" href="#menu3">Working
																		<span class="badge" id="worCount"></span>
																</a></li>
