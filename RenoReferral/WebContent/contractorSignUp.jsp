		...
		<div class="">
			...
			<div class="container-fluid">
				...
				<!-- <span class="pull-right">
					...
					<a class="navbar-brand" href="ContractorSignUp?action=view"><button type="button" class="btn btn-info btn-fill"
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							...
							<div class="card">
								...
								<!--  id="LeadRegisterForm" -->
								<form id="CreateContractorForm" action="ContractorSignUp"
									method="post">

									<div on class="card-header">
										<center>
											<h3 class="card-title">CONTRACTOR SIGN-UP</h3>
										</center>
									</div>
									...
									<div class="card-content">
										<div class="row">
											<input type="hidden" name="stripeToken"
												value="${stripeToken}"> <input type="hidden"
												name="stripeTokenType" value="${stripeTokenType}">
											...
											<input id="contractorSubscription"
												name="contractorSubscription" type="hidden"
											...
											<div class="form-group">
												...
												</label> <input class="form-control" id="contractorSubscriptionName"
													name="contractorSubscriptionName" type="rext"
													required="true" value="${subscription.subscriptionName}"
													readonly="readonly">
											</div>
											...
											<div class="form-group">
												...
												<select multiple title="Multiple Select"
													name="contractorServices" class="selectpicker"
													required="true">
											...
											<div class="form-group">
												...
												</label> <input class="form-control name" id="contractorName"
											...
											<div class="form-group">
												<label class="control-label"> Email Address <star>*</star>
													...
													email="true" autocomplete="off" value="${stripeEmail}"
													maxlength="50" />
											</div>
	                                      ...
	                                      <label class="  control-label">City<star>*</star></label>
	                                      ...
	                                      <label class="  control-label">Postal Code<star>*</star></label>
											...
											<div class="form-group">
												...
												<select multiple title="Multiple Select"
													...
													class="selectpicker" data-size="5" data-live-search="true">
									...
									<div class="card-footer">
										<button type="submit" name="button" value="save"
											class="btn btn-info btn-fill">Submit</button>
