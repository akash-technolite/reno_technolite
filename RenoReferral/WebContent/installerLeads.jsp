								...
								<div class="card">
									<div class="card-header">
										...
										<ul class="nav nav-pills nav-justified">
											<!-- <li class="active"><a data-toggle="tab" href="#menu1">New <span class="badge" id="newCount" ></span></a></li>
												...
												<li><a data-toggle="tab" href="#menu4">Consulted <span id="conCount" class="badge"></span></a></li>
												<li><a data-toggle="tab" href="#menu5">Quoted <span id="quoCount" class="badge"></span></a></li>
												<li><a data-toggle="tab" href="#menu6">Sold <span id="solCount" class="badge"></span></a></li> -->
											<li class="active"><a data-toggle="tab" href="#menu7">Work_Started
													<span id="wosCount" class="badge"></span>
											</a></li>
											<li><a data-toggle="tab" href="#menu8">Work_Completed
													<span id="wocCount" class="badge"></span>
											</a></li>
											<!-- <li><a data-toggle="tab" href="#menu9">Invoiced <span id="invCount"  class="badge"></span></a></li>
												<li><a data-toggle="tab" href="#menu10">Closed <span id="cloCount"  class="badge"></span></a></li>
												<li><a data-toggle="tab" href="#menu11">Canceled <span id="canCount"  class="badge"></span></a></li> -->
										</ul>
									...
									<div class="card-content">
										...
										<tr>
											...
											<table id="consultedLeads" class="table table-striped  table-hover" cellspacing="0" width="100%" style="width:100%">
									    	<thead>
											<tr>
											    <th>Lead Id</th>
											     <th>Name</th>
										...
										<tr>
												...
												<!-- <a data-toggle="modal" data-dismiss="modal" data-target="#myModal" id="assignBtn"  onclick="assignLead(this)" class="btn btn-simple btn-info btn-icon like">Assign</a> -->
												 <a id="estimateBtn" href="ContractorController?action=estimate&leadId=${newLead.leadID}"    class="btn btn-simple btn-info btn-icon like">Estimate</a>
										    	  ...
										    	  <form action="ContractorController" method="post">
												    ...
												    <input type="hidden" name="leadId" value="${newLead.leadID}" >
													<button type="submit" class="btn btn-simple btn-info btn-icon like">Estimate</button>
												</form>
										    	   ...
										    	   <form action="ContractorFlowController" method="post">
										    	    ...
										    	    <form action="ContractorFlowController" method="post"
										    	   onsubmit="return confirm('Do you really want to move this lead? This action cannot be undone');">
												    <input type="hidden" name="action" value="moveToQuoted" >
												    <input type="hidden" name="lead_id" value="${newLead.leadID}" >
													<button type="submit" class="btn btn-simple btn-info btn-icon like">Move</button>
												</form>
											...
											<table id="quotedLeads" class="table table-striped  table-hover" cellspacing="0" width="100%" style="width:100%">
									    	<thead>
											<tr>
											    <th>Lead Id</th>
											     <th>Name</th>
										...
										<tr>
											...
											<table id="soldLeads" class="table table-striped  table-hover" cellspacing="0" width="100%" style="width:100%">
									    	<thead>
											<tr>
											    <th>Lead Id</th>
											     <th>Name</th>
										...
										<tr>
										    	...
										    	<form action="ContractorFlowController" method="post">
										    	   ...
										    	   <form action="ContractorFlowController" method="post"
										    	    onsubmit="return confirm('Do you really want to move this lead? This action cannot be undone');">
												    <input type="hidden" name="action" value="moveToWorkStarted" >
												    <input type="hidden" name="lead_id" value="${newLead.leadID}" >
													<button type="submit" class="btn btn-simple btn-info btn-icon like">Move</button>
												</form> 
											...
											<div id="menu7" class="tab-pane fade  in active">
										    	...
										    	--%> <%--  <form action="ContractorFlowController" method="post"
										    	    onsubmit="return confirm('Do you really want to move this lead? This action cannot be undone');">
												    <input type="hidden" name="action" value="moveWorkCompleted" >
												    <input type="hidden" name="lead_id" value="${newLead.leadID}" >
													<button type="submit" class="btn btn-simple btn-info btn-icon like">Move</button>
												</form>  --%>
																	<div class="row">
																		<div class="col-md-12">
																			...
																			<div class="">
																				<form action="InstallerController" method="post">
																					<input type="hidden" name="action"
																						value="installerleadNotes"> <input
																						type="hidden" name="lead_id"
																						value="${newLead.leadID}">
																					<button type="submit"
											...
											<div id="menu8" class="tab-pane fade">
										    	...
										    	<form action="ContractorFlowController" method="post">
										    	 ...
										    	 --%> <%-- <form action="ContractorFlowController" method="post"
										    	    onsubmit="return confirm('Do you really want to move this lead? This action cannot be undone');">
												    <input type="hidden" name="action" value="moveToClosed" >
												    <input type="hidden" name="lead_id" value="${newLead.leadID}" >
													<button type="submit" class="btn btn-simple btn-info btn-icon like">Close Lead</button>
												</form> --%> <%-- <form action="ComplaintController" method="post">
												    <input type="hidden" name="action" value="showComplaints" >
												    <input type="hidden" name="lead_id" value="${newLead.leadID}" >
													<button type="submit" class="btn btn-simple btn-info btn-icon like">Complaint</button>
												</form> --%> <%-- <form action="ContractorFlowController" method="post"
										    	    onsubmit="return confirm('Do you really want to move this lead? This action cannot be undone');">
												    <input type="hidden" name="action" value="moveToInvoice" >
												    <input type="hidden" name="lead_id" value="${newLead.leadID}" >
													<button type="submit" class="btn btn-simple btn-info btn-icon like">Move</button>
												</form> --%>
																	<div class="row">
										...
										<table id="invoicedLeads" class="table table-striped  table-hover" cellspacing="0" width="100%" style="width:100%">
									    	<thead>
											<tr>
											    <th>Lead Id</th>
											     <th>Name</th>
										...
										<tr>
											...
											<div id="menu10" class="tab-pane fade">
												<h3>Closed Leads</h3>
												<table id="closedLeads" class="table table-striped  table-hover" cellspacing="0" width="100%" style="width:100%">
									    	<thead>
											<tr>
											    <th>Lead Id</th>
											     <th>Name</th>
										...
										<tr>
											...
											<div id="menu11" class="tab-pane fade">
												...
												<table id="cancledLeads" class="table table-striped  table-hover" cellspacing="0" width="100%" style="width:100%">
									    	<thead>
											<tr>
											    <th>Lead Id</th>
											     <th>Name</th>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6" style="word-wrap: break-word;">
								...
								<!-- <div class="col-md-12 scrollbar" style="height:200px;overflow-y:scroll;">
	 ...
	 $.get('AjaxForLeadDetails',{
		contractorId:contractorId,leadId:leadId
			...
			$.each(responseJson.leadEstimations,function(key,value){ 
				...
				$("#vEstimations").append($("<li>").text(value.estimation_title+" : "+value.estimation_status));  
			...
			$("#vInvoices").append($("<li>").text(value.invoice_title+" : "+value.invoice_status));  
